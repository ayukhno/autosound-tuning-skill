...
- **The intake as a FORM the skill serves itself — `rew_tool/intake_form.py`** (S-033, the Arbiter's
  decision 2026-09-19). `intake.py` made the questions data; this is the page that renders them and
