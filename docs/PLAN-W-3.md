...
Opened 2026-09-23, straight after v3.0.61. The composition was agreed with the Arbiter the same day: everything open
...
| **#24** | The de/pl listening references lag | `c17` in both cheat sheets. `test-tracks.de.md` / `.pl.md` with the 98 cues and the titles. `listening.coverage(lang)` as a report |
