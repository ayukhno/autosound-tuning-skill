...
(hub #149, HUB-065), the findings S-009 and S-010, one title parser (#39: #33, #34, hub #152), and the records that
could not hold what the method teaches (#40: #29, #30, #31, #32, #36). Left: the review with the user of what goes in,
