# CHANGELOG archive — v1.0.0 … v3.0.20

Version notes up to and including **v3.0.20** (2026-08-23), moved out of
[`../../CHANGELOG.md`](../../CHANGELOG.md) on 2026-09-09: the live file had grown to 3 297 lines /
292 KB, and half of it was history nobody upgrades FROM any more. Nothing here was rewritten or
shortened — these are the notes as they were written, newest first.

**The index of every version — the ones in this file included — is at the top of
[`../../CHANGELOG.md`](../../CHANGELOG.md)** (autosound-hub `HUB-043`). What a version number
means, and the rule that a published tag is never moved, live there too.
