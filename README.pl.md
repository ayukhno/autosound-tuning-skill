...
* **Który model jak dotąd jest najbardziej niezawodny jako prowadzący:** **Claude Opus** dawał dotychczas najstabilniejsze wyniki. **Sonnet 5** działa, ale jak dotąd wydaje się mniej pewny siebie w tej roli — warto na razie dokładniej sprawdzać jego decyzje. **Fable 5** dał dotychczas najlepszy wynik ze wszystkich modeli: w tej samej sesji, w której przeprowadził audyt i przebudował skill (zob. [audit-fable-2026-07-11.md](audit-fable-2026-07-11.md)), przeprowadził też pełną sesję strojenia — i to obecnie najlepszy wynik pod względem brzmienia. **Gemini** stracił trochę możliwości wraz ze wzrostem złożoności regulaminu; od tego czasu przeprowadzono audyt i optymalizację, które powinny to poprawić, ale nie zostały jeszcze zweryfikowane w realnej sesji — czekamy na opinie społeczności.
