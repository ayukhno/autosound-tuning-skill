...
Claude **збирає КОНКРЕТНІ напрацювання цього проекту** (нові прийоми, вдалі рішення, quirks DSP/заліза, аномалії кузова) і подає **списком, де КОЖЕН пункт уже ПЕРЕДВИДІЛЕНИЙ (☑)**. Користувач **знімає** те, чим не хоче ділитись (**opt-out, не opt-in** — менше тертя, більший внесок), і тисне **«Погоджуюсь відправити на користь спільноті!»**.
