...
**1. Коротке опитування результату** (3-4 питання, звичайною розмовою — не форма):
- Чи досягли цілей цієї сесії? *(так / частково / ні — якщо ні-частково: що лишилось?)*
- Що зараз звучить найкраще?
- Що ще муляє або хотілось би докрутити?
- Загальне враження? *(просте: 🙂 / 😐 / 🙁, або 1-5)*

→ відповіді в session log (changelog) + сирий матеріал для фідбек-пакета. Опитування корисне двічі: майстру — зворотний зв'язок про звук і backlog, скілу — сигнал, чи метод працює.
