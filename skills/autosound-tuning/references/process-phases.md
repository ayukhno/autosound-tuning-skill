...
Захисні кроси для сирих замірів — **консервативний ЗАХИСТ драйверів** (щоб не спалити на свипі), НЕ фінальна стратегія: HP СЧ/ВЧ **на/вище РЕАЛЬНОГО резонансу драйвера** (типово СЧ ~100 Гц LR4, ВЧ ≥1 кГц LR4 — **уточнити під конкретні драйвери, підтвердити з користувачем**), сабсонік для ЗЯ. ⚠️ **Фінальні крос-точки/типи — Фаза 1** (запропонувати / вивести з виміру, НЕ прескрайбити таблицею; не підставляти драйвери, яких користувач не давав). Назви кривих — за глосарієм `autosound_context.md` §5.
