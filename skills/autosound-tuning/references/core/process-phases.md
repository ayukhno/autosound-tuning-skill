...
| **Phase 4** | [phase_4_listening.md](references/phases/phase_4_listening.md) | Systematic test-track listening pass → **satisfied with the sound** → feedback → **session close** (backup · experience via a GitHub Issue, or the Arbiter's form without GitHub). |
