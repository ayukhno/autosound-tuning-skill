...
**An observation on a real tune (a DIMOSUS session, 2026-08-23):** 44 PEQ bands, 16 with Q > 6, 13 of
them on the tweeter and almost all above 1 kHz; the sides correct **different frequencies** (within 5 %,
channel B: 0 shared, C: 1, D: 3 of 23). As the listener moves, the left and right errors change
independently → the L/R balance drifts → the stage does not hold still.

⚠️ **Whose bands these are is NOT established** — they could be the user's own tune carried into
Resonalyze, or generated by its EQ Wizard. The frequencies look machine-made (3718, 5238, 10862 Hz), but
the user's own processor could produce those too. **Do not draw a conclusion about anyone's work from
this until the user says.**
