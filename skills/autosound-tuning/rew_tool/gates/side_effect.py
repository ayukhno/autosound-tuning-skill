...
def _selftest():
    ...
    print("selftest OK — verified good post; FAIL LOUD on wrong-repo / confabulated-success / "
          "gh-failure / look-alike host; refused missing body-file + shell-string argv; dry-run safe.")
    return 0
