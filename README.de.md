...
```sh
curl -fsSL https://raw.githubusercontent.com/ayukhno/autosound-tuning-skill/v3.0.51/install.sh | bash
```

**Windows** — öffne PowerShell (Start drücken, "powershell" tippen, Enter) und füge ein:
```powershell
irm https://raw.githubusercontent.com/ayukhno/autosound-tuning-skill/v3.0.51/install.ps1 | iex
```
