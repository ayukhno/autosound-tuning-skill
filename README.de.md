...
* **Welches Modell bisher am zuverlässigsten als Fahrer ist:** **Claude Opus** hat bisher die stabilsten Ergebnisse geliefert. **Sonnet 5** funktioniert, wirkt in dieser Rolle aber bisher weniger sicher — seine Entscheidungen sollte man vorerst genauer prüfen. **Fable 5** hat die besten Ergebnisse aller Modelle erzielt, allerdings bei der *Meta*-Aufgabe, den Skill selbst auf- und auszubauen (siehe [audit-fable-2026-07-11.md](audit-fable-2026-07-11.md)), nicht beim Führen einer Abstimmung — vielversprechend, wenn du den Skill erweiterst statt ihn anzuwenden. **Gemini** hat mit zunehmender Komplexität der Prozessregeln etwas an Leistungsfähigkeit eingebüßt; seitdem wurden ein Audit und eine Optimierung durchgeführt, die das beheben sollten, aber das ist in einer echten Sitzung noch nicht bestätigt — Rückmeldungen aus der Community sind hier willkommen.
