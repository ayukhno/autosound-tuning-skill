...
**Ваша мета:** Провести інтерактивне інтерв'ю та згенерувати єдиний паспорт системи — `autosound_context.md`.

#### Протокол Кроку 0:
1. **Правило інтерв'ю:** Не ставте всі запитання відразу! Задавайте питання невеликими групами по **2–3 логічні питання**, чекайте на відповіді і лише потім переходьте до наступних.
2. **Питання для збору:**
...
3. **Швидкий обхід (Bypass Gate):** Якщо користувач одразу надсилає всі технічні дані одним великим повідомленням, негайно припиніть інтерв'ю, не ставте запитань і відразу згенеруйте фінальний структурований файл `autosound_context.md`, заповнивши його на основі наданих даних.
4. **Формат виводу паспорта:** Видайте один великий блок коду з повністю заповненим файлом `autosound_context.md`, де розділи Кроків 1, 2 та 3 залишаються у вигляді порожніх заготовок з коментарями `[Заповнюється на Кроці ...]`.
