...
* Я підтверджую, що всі базові кросовери, затримки та початкові гейни з Кроку 1 повністю активовані v DSP процесорі.

Я завантажую текстові експорти моїх нових вимірів зі згладжуванням 1/6 або 1/12 oct (RTA, одиночні свипи та свипи сумарних стиків: L w+m_2, R w+m_2, L m+tw_2, R m+tw_2, SW+Ws_2 у файлах .txt / .csv):
